        ...
        try {
            ...
            body.DataCollection.map(async (lessonDataReview:LessonDataReviewDto)=>{
              if(lessonDataReview.reviewStatus != null && lessonDataReview.reviewStatus != undefined && lessonDataReview.reviewStatus != true){
                ...
                this.utilityFacade.createNotification(result.getDataCollection()[0].lesson.CreatedBy,Label.lessonRejected,NotificationType.email,lessonDataReview.CreationDate,lessonNotificationData);  
                this.utilityFacade.createNotification(result.getDataCollection()[0].lesson.CreatedBy,Label.courseRejected,NotificationType.email,lessonDataReview.CreationDate,courseNotificationData);  
